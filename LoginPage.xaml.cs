...
namespace ProfanityShock
{
    public partial class LoginPage : ContentPage
    {
        ...
        private async void OnCounterClicked(object sender, EventArgs e)
        {
            ...
            string response = await client.GetStringAsync(AccountManager.GetConfig().Backend + "1/public/stats");
        ...
        private async void OnLoginButtonClicked(object sender, EventArgs e)
        {
            ...
            var response = client.PostAsync(AccountManager.GetConfig().Backend + "2/account/login", content).GetAwaiter().GetResult();
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var tokenResponse = client.PostAsync(AccountManager.GetConfig().Backend + "1/tokens", tokenContent).GetAwaiter().GetResult();
        ...
        {
            var response = client.PostAsync(AccountManager.GetConfig().Backend + "1/account/logout", null).GetAwaiter().GetResult();
        ...
        {
            var response = client.GetAsync(AccountManager.GetConfig().Backend + "1/tokens/self").GetAwaiter().GetResult();
        ...
        private async void OnTokenLoginButtonClicked(object sender, EventArgs e)
        {
            ...
            var response = NetManager.GetClient().GetAsync("1/tokens/self").GetAwaiter().GetResult();
